...
- Run `node ./scripts/arduino-test.js` to verify the serial port is found
...
- Accept the warning if shown
- Search for: media.videocontrols.picture-in-picture.enabled
